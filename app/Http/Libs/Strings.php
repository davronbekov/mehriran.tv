...
class Strings
{
     ...
     * @return String
     */
    public static function toCyril(String $string) : String{
     ...
     * @return String
     */
    public static function toCapital(String $string) : String{
     ...
     * @return bool
     */
    public static function isContains(String $original, String $search) : bool {
        return (strpos($original, $search) !== false) ? true : false;
    }
     ...
     * @return String
     */
    public static function arrayToQueryString($array = []) : String{
