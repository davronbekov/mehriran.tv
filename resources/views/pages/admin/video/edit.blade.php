...
@section('content')
    ...
    <form class="row" method="post" action="{{ route('admin.video.destroy', $videoFile->id) }}">
        @csrf
        @method('delete')
        <div class="col-md-12">
    ...
    <form class="row" method="post" action="{{ route('admin.video.update', $videoFile->id) }}"  enctype="multipart/form-data">
        @method('put')
        @csrf
        <div class="col-md-3">
            <div class="row">
                ...
                <div class="col-md-12 mt-3">
                    <div class="input-group">
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label" for="inputGroupFile04">Choose snapshot of video</label>
                        </div>
                    </div>
                </div>
