$(function() {
     ...
     */
    $.get('/admin/filebrowser/scan', function(data) {
        let response = [data],
            currentPath = '',
            breadcrumbsUrls = [];
        ...
        function render(data)
        {
            ...
            if(scannedFiles.length) {
                scannedFiles.forEach(function(f) {
                    ...
                    let file = $(
                        '<li class="files">' +
                        '<a href="/admin/files/attach?path='+encodeURIComponent(f.path)+'&name='+encodeURIComponent(f.name)+'&root='+encodeURIComponent(f.root)+'" title="'+ f.path +'" class="files">'+icon+'<span class="name">'+ name +
